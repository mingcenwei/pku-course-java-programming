...
public class App
{
    ...
    {
        System.out.println(query("[\"getNumberOfUnansweredQuestionsUnderTopic\", \"t75o481WO6X3iStTiqE9yJu2V5RSFM\", \"1000001\"]"));
    }
    ...
    public static String createNewAccount(String emailAddress, String username, String password)
    {
    ...
    public static String createQuestion(String token, String topicId, String questionTitle, String questionText)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
    ...
    public static String writeAnswer(String token, String questionId, String answerText)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
    ...
    public static String createTopic(String token, String topicTitle, String topicDescription)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
    ...
    public static String modifyPassword(String token, String oldPassword, String newPassword)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
    ...
    public static String followTopic(String token, String topicId, String followOrUnfollow)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
        ...
        )
        {
            ...
            statement.setBigDecimal(1, new BigDecimal(topicId));
            statement.setBigDecimal(2, accountId);
            if (followOrUnfollow.equals("True"))
            {
    ...
    public static String followQuestion(String token, String questionId, String followOrUnfollow)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
    ...
    public static String getNumberOfUnansweredQuestionsUnderTopic(String token, String topicId)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
        ...
        {
            String sqlCode =
                "SELECT COUNT(t1.[QUESTION_ID]) FROM [QUESTIONS] AS t1 " +
                "WHERE t1.[TOPIC_ID] = ? " +
                "AND NOT EXISTS (SELECT * FROM [ANSWERS] AS t2 WHERE " +
    ...
    public static String getTopTenAccounts(String token)
    {
        BigDecimal accountId = _verifyToken(token);
        if (accountId == null)
        {
        ...
        try
        {
            ...
            switch ((String) jsonArray.get(0))
            {
                ...
                case "searchTopics":
                    ...
                    break;
                case "fetchTopicById":
                    result = fetchTopicById((String) jsonArray.get(1),
                        (String) jsonArray.get(2)
                    );
                    break;
                case "getNumberOfUnansweredQuestionsUnderTopic":
                    result = getNumberOfUnansweredQuestionsUnderTopic((String) jsonArray.get(1),
                    (String) jsonArray.get(2)
                    );
                    break;
                case "getTopTenAccounts":
                    result = getTopTenAccounts((String) jsonArray.get(1)
                    );
                    break;
                default:
                    break;
